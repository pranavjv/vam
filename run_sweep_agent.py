...
from sweep_vadam import train_model, create_vadam_sweep_config, create_adam_sweep_config, create_sgd_sweep_config, create_rmsprop_sweep_config
...
def run_sweep_agent(optimizer_name, model_type, dataset, count=10):
    ...
    Args:
        optimizer_name: Name of the optimizer ('VADAM' or 'ADAM' or 'SGD' or 'RMSPROP')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run a W&B sweep agent for VADAM, ADAM, SGD, or RMSPROP optimization")
